...
%%% Essentials
\name{Rajat}{Khemka}
\address{G-2-10, Aryabhatt Hostel, KNIT Sultanpur, 228118, Sultanpur, UP, INDIA}
\mobile{(+91) 9169-536892} 
%%% Social
\email{khemka.rajat@gmail.com}
\github{rajatkhemka}
\linkedin{rajat-khemka-27b84b71}
%%% Optionals
\position{Undergrad{\enskip\cdotp\enskip}KNIT Sultanpur}
\quote{``Believes in creating opportunity rather waiting for it"}
